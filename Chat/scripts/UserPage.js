...
$(document).ready(function () {
  ...
  pfnum = 8817;
                        ...
                        $("#divMsgs").append($("<div>").addClass("res")
                            ...
                            .append($("<a>")
                                ...
                                .append($("<img>")
                                    .addClass("tn")
                                    .prop("alt", val)
                                    .prop("src", "getThumbNail.ashx?file=" + val + "<span class='fullTime'>" + hm_date + hm_time + "</span>"))));
                        $("#divMsgs").prop({ scrollTop: $("#divMsgs").prop("scrollHeight") });
    ...
    $("#ulUsers").on("click", "li.OnlineUsers", function () {
        // slide animation 
        $('.chatBox').addClass('pullRightShow');
        $('.threads').addClass('pullRightHide'); 
    ...
    // hide Sticky Footer Chatbox
    $('.threadHead .icon-bubbles2').click(function () {
        $(this).parent().parent().parent().toggleClass("showChat");
    });
    $("#ClearUser").click(function (e) {
        e.preventDefault();
        $('.chatBox').removeClass('pullRightShow');
        $('.threads').removeClass('pullRightHide'); 
    });
    ...
    $("#divMsgs").on("click", "span.loadOld", function (e) {
       ...
       //  alert($(this).data("todate"));
        ...
        // var fromdate = new Date();
         var fromdate = $(this).data("todate");

        var msg = {
            type: "ondemand",
            toconnid: $(this).data("pfnum"),
            fromdate:fromdate                              // fromdate: $(this).data("todate")
            //todate:fromdate
        }
        connection.send(msg);
